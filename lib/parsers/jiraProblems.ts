...
const RULES: Record<JiraProblem, Rule> = {
  ...
  'story-done-without-resolution': (issue) =>
    isStory(issue) && issue.statusCategory === 'done' && !issue.resolvedAt,
...
export const PROBLEM_LABEL: Record<JiraProblem, string> = {
  ...
  'story-done-without-resolution': 'concluída sem data de conclusão',
